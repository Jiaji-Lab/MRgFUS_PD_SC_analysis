...
do
    ...
    dcm2nii -4 Y -o ./ -z Y -f dwi ./DTI
    dcm2nii -4 Y -o ./ -z Y -f t1 ./T1
    ...
    reg_resample -ref brain_diff.nii.gz -flo ../atlas/BN_Atlas_246_1mm.nii.gz -res BN_Atlas_246_1mm.nii.gz -trans outputCPP.nii -inter 0
    ...
    #### "BN_Atlas_246.txt" to get all the ROIs (cerebellum excluded).
    i=1
    for roi in `cat ../atlas/BN_Atlas_246.txt`
    do
        echo $roi
        echo $i
        bncalc  -i BN_Atlas_246_1mm.nii.gz -dthr $i -uthr $i -o $roi
        i=$(($i+1));
    done
    ...
    #### network you can replace all_roi_024.txt with BN_Atlas_246.txt to construct network with 90 nodes.
    bnnetwork -fiber dti_wb.trk -roi ../atlas/BN_Atlas_246.txt -outfiber 1 -o network 
    #bnnetwork -fiber dti_wb.trk -roi ../atlas/BN_Atlas_246.txt -outfiber 1 -o network 
